        ...
        <div class="container-fluid px-3">
            <div class="row row-cols-lg-5 text-center">
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="daftar-poli.php?poli=<?php $poli = '101';
                                                            echo $poli;
                                                            ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '102' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php $poli = '103';
                                                            echo $poli; ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '104' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '106' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '107' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '108' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '109' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '110' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '111' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '112' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '113' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '114' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '115' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '116' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '117' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '118' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '119' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '120' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '131' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '134' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '105' ?>">
                ...
                <div class="col mb-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="daftar-poli.php?poli=<?php echo '135' ?>">
